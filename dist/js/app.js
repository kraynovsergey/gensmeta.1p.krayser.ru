...
if (folderOperations) {
    gsapWithCSS.to(folderOperations, {
        y: 0,
        duration: 1,
        delay: 1,
        ease: 'power4.out',
...
if (lines.length > 0) {
    lines.forEach(item => {
        gsapWithCSS.to(item.querySelector('path:first-child'), {
            x: 0,
            duration: 1,
            delay: 1,
            ease: 'power4.out',
        ...
        gsapWithCSS.to(item.querySelector('path:last-child'), {
            x: 0,
            duration: 1,
            delay: 2,
            ease: 'power4.out',
...
;// ./src/js/modules/privacy-policy.js
...
// EXTERNAL MODULE: ./node_modules/nice-select2/dist/js/nice-select2.js
var nice_select2 = __webpack_require__(38);
;// ./src/js/modules/select.js


const select_select = document.querySelectorAll('[data-select]');
if (select_select.length > 0) {
    select_select.forEach(el => {
        const sel = nice_select2.bind(el);
    });
}
// EXTERNAL MODULE: ./node_modules/tabs/index.js
...
if (accordionFaq) {
    new accordion_min(accordionFaq, {
        openOnInit: [0]
    });
}
